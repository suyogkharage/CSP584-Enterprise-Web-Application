...
public class MySqlDataStoreUtilities
{
		...
		public static String getUserName(String uid)
	{
		...
		public static int getproductCount(String pname)
		{
			...
			try 
			{
				Class.forName("com.mysql.jdbc.Driver").newInstance();
				conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/exampledatabase","root","root");
				String getCount = "SELECT currentCount FROM productDetail WHERE productName='"+pname+"';";
		...
		public static void setproductCount(String pname,int count)
		{
			...
			try 
			{
				Class.forName("com.mysql.jdbc.Driver").newInstance();
				conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/exampledatabase","root","root");
				String setCount = "UPDATE productDetail SET currentCount ='"+count+"' WHERE productName='"+pname+"';";
  ...
  public static String getUserType(String uid)
		...
		public static List<productDetail> getInventoryTable() throws SQLException {
	        ...
	        try {
	        		Class.forName("com.mysql.jdbc.Driver");
	    			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/exampledatabase","root","root");
	    			String getOrders = "SELECT * FROM productDetail";
...
public static List<productDetail> getRebateList() throws SQLException {
    ...
    try {
    		Class.forName("com.mysql.jdbc.Driver");
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/exampledatabase","root","root");
			String getOrders = "SELECT * FROM productDetail WHERE rebate IS NOT NULL";
