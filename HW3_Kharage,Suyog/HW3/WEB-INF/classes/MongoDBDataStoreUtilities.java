...
public class MongoDBDataStoreUtilities {
	...
	public static String insertReview(String productname,String producttype,String username,String productmaker,String reviewrating,String reviewtext,String price)
	{
		try
			{		
				getConnection();
		...
		while (cursor.hasNext())
		{
			   ...
			   if(!reviews.containsKey(obj.getString("productName")))
				...
				Review review =new Review(obj.getString("productName"),obj.getString("userName"),obj.getString("productType"),obj.getString("productMaker"),
					obj.getString("reviewRating"),obj.getString("reviewText"),obj.getString("price"));
