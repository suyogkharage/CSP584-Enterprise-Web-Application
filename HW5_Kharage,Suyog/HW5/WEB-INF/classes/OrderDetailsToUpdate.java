...
public class OrderDetailsToUpdate extends HttpServlet{
	 public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		 response.setContentType("text/html;charset=UTF-8");
			...
			String orderName = request.getParameter("OrderNameToBeUpdated");
			...
			if(fname == null) 
			{
				...
				out.println("<div class='row'>");
					...
					out.println("<br><a style='font-size: 24px;'>Order Name To be Updated: "+orderName+"</a><br>");
					out.println("<form class='form-horizontal' action='UpdateOrder' method='get'>");
					  
					out.println("<div class='form-group'>");
					out.println("<label class='control-label col-sm-2' for='address'>Address:</label>");
					out.println("<div class='col-sm-10'>");
					out.println("<input type='text' class='form-control' name='address' 'id='address' placeholder='Enter address'>");
					out.println("<input type='hidden' name='orderName' value='"+orderName+"'>");
					out.println("</div></div>");
					
					out.println("<div class='form-group'>");
					out.println("<label class='control-label col-sm-2' for='zip'>Zipcode:</label>");
					out.println("<div class='col-sm-10'>");
					out.println("<input type='text' class='form-control' name='zip' 'id='zip' placeholder='Enter zipcode'>");
					out.println("</div></div>");
