...
public class SelectOrderForUpdate extends HttpServlet{
	...
	//	  o = list.get(0);
		...
		if(fname == null) 
		{
			...
			out.println("<div class='row'>");
				...
				out.println("<form class='form-horizontal' action='OrderDetailsToUpdate' method='get'>");
				  
				out.println("<div class='form-group'>");
				out.println("<label class='control-label col-sm-2' for='email'>Choose Product:</label>");
				out.println("<div class='col-sm-10'>");
				
				out.println("<select name='OrderNameToBeUpdated'>");
