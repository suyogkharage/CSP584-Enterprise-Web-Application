  ...
  out.println("<script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js'></script>");
    ...
    out.println("<div class='item'>");
	  ...
	  out.println("<div class='carousel-caption'>");
          out.println("<h3>Smart Speakers</h3>");
...
out.println("</div>");
	...
	//out.println("<img class='header-image' src='images/Homepage.png' width = '80%' height = '80%' alt='Index Page Image' />");
	...
	out.println("<li><a href='VirtualReality'>Virtual Reality</a></li>");
